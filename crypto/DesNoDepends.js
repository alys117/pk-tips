/**
* DES加密/解密，这个版本的DES加密/解密是基于ECMAScript实现的，不依赖任何第三方库，但是有三个key，和网上的DES加密/解密不一样。
 ...
 */
 ...
 function test() {
  ...
  console.log("decbyte="+decbyte);
  console.log("decmsg="+decmsg);  
 }

 test()

var a = strEnc('userid=lihanzhang&usercityid=999','1','2','3')
console.log(a);
var b = strEnc('userid=lihanzhang&usercityid=999',1)
console.log(b);