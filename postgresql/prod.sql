/*
 ...
 Source Server         : 外教（客户腾讯云）
 Source Server Type    : PostgreSQL
 Source Server Version : 110014
 Source Host           : localhost:5432
 Source Catalog        : teacher_0623
...
COMMENT ON COLUMN "public"."order"."pay_time" IS '付款时间';
COMMENT ON COLUMN "public"."order"."is_bill" IS '是否开票';
COMMENT ON COLUMN "public"."order"."real_fee" IS '实收金额';
COMMENT ON COLUMN "public"."order"."collected_time" IS '收款时间';
...
COMMENT ON COLUMN "public"."upload_info"."teacher_file_id" IS '1:个人照片 2:个人视频简介 3:护照照片 4:教育相关证书图片 5:学历证书 6:个人简历';
...
-- ----------------------------
SELECT setval('"public"."comment_id_seq"', 2928, true);
...
SELECT setval('"public"."company_id_seq"', 89, true);
...
SELECT setval('"public"."offer_id_seq"', 503, true);

-- ----------------------------
-- Alter sequences owned by
-- ----------------------------
SELECT setval('"public"."order_id_seq"', 166, true);
...
-- Alter sequences owned by
-- ----------------------------
SELECT setval('"public"."teacher_id_seq"', 1257, true);
...
SELECT setval('"public"."upload_info_id_seq"', 3621, true);
...
SELECT setval('"public"."user_info_id_seq"', 125, true);
...
SELECT setval('"public"."user_log_id_seq"', 2904, true);
