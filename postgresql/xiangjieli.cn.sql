/*
 ...
 Source Server         : xiangjieli.cn
 Source Server Type    : PostgreSQL
 Source Server Version : 110014
 Source Host           : xiangjieli.cn:22160
...
-- ----------------------------
-- Sequence structure for order_remind_id_seq
-- ----------------------------
DROP SEQUENCE IF EXISTS "public"."order_remind_id_seq";
CREATE SEQUENCE "public"."order_remind_id_seq" 
INCREMENT 1
MINVALUE  1
MAXVALUE 2147483647
START 1
...
COMMENT ON COLUMN "public"."dict"."type" IS '类型id';
COMMENT ON COLUMN "public"."dict"."type_name" IS '类型名称';
COMMENT ON COLUMN "public"."dict"."sub_id" IS '子类型id';
COMMENT ON COLUMN "public"."dict"."sub_name" IS '子类型名称';
...
CREATE TABLE "public"."nation" (
  "id" int4 NOT NULL,
  "nation_en" varchar(255) COLLATE "pg_catalog"."default" NOT NULL,
  "nation_zh" varchar(255) COLLATE "pg_catalog"."default" NOT NULL
)
;
COMMENT ON COLUMN "public"."nation"."nation_en" IS '国籍英文';
COMMENT ON COLUMN "public"."nation"."nation_zh" IS '国籍中文';
...
-- ----------------------------
DROP TABLE IF EXISTS "public"."order_remind";
CREATE TABLE "public"."order_remind" (
  "id" int4 NOT NULL DEFAULT nextval('order_remind_id_seq'::regclass),
  "user_id" int4,
...
COMMENT ON COLUMN "public"."teacher"."com_people" IS '对接人员1：招募官，2：推荐官（废弃，用订单表关联），3：其他人员';
COMMENT ON COLUMN "public"."teacher"."com_people_id" IS '废弃
废弃';
...
COMMENT ON COLUMN "public"."teacher"."commit" IS '评论，废弃，用comment表关联';
...
-- ----------------------------
SELECT setval('"public"."comment_id_seq"', 2711, true);
...
SELECT setval('"public"."company_id_seq"', 106, true);

-- ----------------------------
-- Alter sequences owned by
-- ----------------------------
SELECT setval('"public"."dict_id_seq"', 186, true);

-- ----------------------------
-- Alter sequences owned by
-- ----------------------------
SELECT setval('"public"."favorite_id_seq"', 551, true);
...
SELECT setval('"public"."match_id_seq"', 12, false);
...
SELECT setval('"public"."offer_id_seq"', 474, true);

-- ----------------------------
-- Alter sequences owned by
-- ----------------------------
SELECT setval('"public"."order_id_seq"', 170, true);

-- ----------------------------
-- Alter sequences owned by
-- ----------------------------
SELECT setval('"public"."order_remind_id_seq"', 35, true);
...
SELECT setval('"public"."permission_id_seq"', 19, false);
...
SELECT setval('"public"."role_id_seq"', 19, true);

-- ----------------------------
-- Alter sequences owned by
-- ----------------------------
SELECT setval('"public"."sale_order_id_seq"', 8, false);

-- ----------------------------
-- Alter sequences owned by
-- ----------------------------
SELECT setval('"public"."teacher_comment_id_seq"', 10, false);

-- ----------------------------
-- Alter sequences owned by
-- ----------------------------
SELECT setval('"public"."teacher_id_seq"', 1061, true);

-- ----------------------------
-- Alter sequences owned by
-- ----------------------------
SELECT setval('"public"."teacher_id_seq11"', 9, false);
...
SELECT setval('"public"."upload_info_id_seq"', 3132, true);
...
SELECT setval('"public"."user_info_id_seq"', 131, true);
...
SELECT setval('"public"."user_log_id_seq"', 2990, true);
...
SELECT setval('"public"."visitor_id_seq"', 623, true);

-- ----------------------------
-- Alter sequences owned by
-- ----------------------------
SELECT setval('"public"."website_id_seq"', 6, true);
...
-- ----------------------------
CREATE INDEX "teacher_expect_job_city_idx" ON "public"."teacher" USING hash (
  "expect_job_city" "pg_catalog"."jsonb_ops"
);
